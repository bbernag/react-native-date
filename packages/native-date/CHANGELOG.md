...
- Upgrade Nitro Modules and Nitrogen generation to 0.36.1.
- Require `react-native-nitro-modules >=0.36.0 <0.37.0` for native integration.
- Validate the existing native spec against Nitrogen 0.36.1 with no generated API changes.

### Migration

- Upgrade consuming apps to a Nitro Modules 0.36.x release.
